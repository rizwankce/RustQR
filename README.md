...
| brightness | 28 | 81.18% | 78.82% | 50.59% | **29.41%** |
| bright_spots | 32 | 43.30% | 27.84% | 19.59% | **25.77%** |
| close | 40 | 95.00% | 100.00% | 12.50% | **25.00%** |
| curved | 50 | 70.00% | 56.67% | 35.00% | **33.33%** |
| damaged | 37 | 51.16% | 16.28% | 25.58% | **16.28%** |
| glare | 50 | 84.91% | 32.08% | 35.85% | **37.74%** |
| high_version | 33 | 97.30% | 40.54% | 27.03% | **0.00%** |
| lots | 7 | 100.00% | 99.76% | 18.10% | **0.00%** |
| monitor | 17 | 100.00% | 82.35% | 0.00% | **70.59%** |
| nominal | 65 | 93.59% | 89.74% | 66.67% | **57.69%** |
| noncompliant | 16 | 92.31% | 3.85% | 50.00% | **0.00%** |
| pathological | 23 | 95.65% | 43.48% | 65.22% | **0.00%** |
| perspective | 35 | 62.86% | 80.00% | 42.86% | **28.57%** |
| rotations | 44 | 99.25% | 96.24% | 48.87% | **33.83%** |
| shadows | 14 | 100.00% | 85.00% | 90.00% | **25.00%** |
| **total** | **536** | **83.29%** | **60.69%** | **38.95%** | **20.13%** |

> **Note:** RustQR values above are from GitHub Actions run `21749445501` (`macos-latest`) on commit `3017035` over all 16 categories (536 images, 1232 QR codes).
>
> Run the benchmark:
> ```bash
