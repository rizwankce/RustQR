...
use crate::{BitMatrix, ECLevel, Fnc1Position, QRCodeMetadata, StructuredAppendInfo};
use crate::{DecodeRequestContext, MatrixDecodeResult};
...
pub(crate) fn try_decode_single(
    oriented: &BitMatrix,
    version_num: u8,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn try_decode_single_deterministic_erasures(
    oriented: &BitMatrix,
    version_num: u8,
    format_info: &FormatInfo,
